...
{
    echo "<span class='badge bg-info me-5 ms-5'> $usuario:</span>";
    switch ($cartas) {
        case "C1":
...
<div class="container mt-3">
    <h1>Juego de cartas a comparar con la CPU. ¿Cuál carta es mayor?</h1>
    ...
    <br>
    <button type="submit" class="btn btn-primary" name="enviar" value="enviar" >¡Vamos a descubrirlo!</button>
    </form>
</div>
<?php
}
