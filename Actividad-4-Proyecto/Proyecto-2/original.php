...
<head>
  <meta charset="utf-8">
  <title>Completa la imagen.</title>
    <meta charset="utf-8">
...
<!--Parte inicial del formulario-->
  ...
  <h1>Completa el emoji a continucación:</h1>
...
echo "          <td><button type=\"submit\" class=\"ms-3 btn btn-primary\" name=\"mod\" value=\"2\">"
    . "<img src=\"img/refrescar.svg\" height=\"20\" alt=\"Cambiar\"></button></td>";
echo "        </tr>";
echo "        <tr>";
echo "          <td><h2 class=\"d-flex\">Ojos</h2></td>";
echo "          <td><img class=\"img\" src=\"img/images/imagen-$_SESSION[b]-2.png\" alt=\"Mitad\"></td>\n";
echo "          <td><button type=\"submit\" class=\"ms-3 btn btn-primary\" name=\"mod\" value=\"1\">"
    . "<img src=\"img/refrescar.svg\" height=\"20\" alt=\"Cambiar\"></button></td>";
echo "        </tr>";
echo "        <tr>";
echo "          <td><h2 class=\"d-flex\">Boca</h2></td>";
echo "          <td><img class=\"img\" src=\"img/images/imagen-$_SESSION[a]-3.png\" alt=\"Abajo\"></td>\n";
echo "          <td><button type=\"submit\" class=\"ms-3 btn btn-primary\" name=\"mod\" value=\"0\">"
    . "<img src=\"img/refrescar.svg\" height=\"20\" alt=\"Cambiar\"></button></td>";
echo "        </tr>";
