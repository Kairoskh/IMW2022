...
<div class="container">
   <div class="row">
       <h2>Resultados de la búsqueda de PRODUCTOS:</h2>
        ...
        $query = mysqli_query($conn, "SELECT id, empresa, direccion, envios_recientes, telefono, provincia, unidades_vendidas, categoria FROM proveedores");
        ...
        ?>
            ...
            <img src="images/proveedor0.jpg" class="card-img-top" alt="foto">
