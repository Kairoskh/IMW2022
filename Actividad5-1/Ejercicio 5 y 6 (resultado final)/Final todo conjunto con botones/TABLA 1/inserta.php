...
if (isset($_POST["Enviar"]))  { 
  ...
  $sqlInsert = mysqli_query($conn,"INSERT INTO productos(nombre, fabricacion, fecha_salida, numero ,marca, precio, categoria) 
  values ('$nombre','$fabricacion','$fecha_salida','$numero','$marca','$precio','$categoria');");
...
get_header();
?>
<!--FORMULARIO DE INSERCIÓN DE ESTUDIANTES-->
