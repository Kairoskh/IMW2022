...
<div class="container">
    <div class="row main-container justify-content-center">
        <div class="col col-md-4 justify-content-center">
            <img src="images/busqueda1.png" class="img-fluid" alt="busqueda">
            ...
            <form method="POST" class="form-inline" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                <input class="form-control" name="buscaproveedores" type="search" placeholder="Búsqueda de proveedores (empresa o categoria)" aria-label="Search">
