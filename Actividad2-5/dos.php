...
/*Escribe un script que muestre un formulario con varios campos de texto y que permita enviarlos usando el método POST. 
...
if (isset($_POST['enviar']))
{
    ...
    echo "<h1>Los datos recogidos son:</h1> <br/>Nombre: $nombre <br/> Apellido: $apellido <br/>";
    echo " Direccion: Calle $calle CP $codigo en $localidad <br/>";
    echo "Correo electrónico: $correo <br/>";
    
    echo "<br><br><a class='btn btn-primary text-white text-decoration-none' href='dos.php'>Regresar</a>";
}
else
{
?>
