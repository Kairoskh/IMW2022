...
if (isset($_POST["Entrar"]))  
{
    ...
    if($resul['id'] == $usuario && $resul['pass'] == $pass){
        ...
        // Vamos a búsqueda
        header("location:busquedaproveedores.php");
    }else{
...
<div class="container mb-5">
    <div class="row main-container justify-content-center align-items-center">
        ...
        <h2 class="text-center">Bienvenid@ a la aplicación <span class="text-primary">Gestión de proveedores</span></h2>
