    ...
    <div class="row gx-4">
        ...
        <img src="<?php echo $resul['foto'];?>" class='rounded mx-auto d-block' alt='Funko'>
            ...
            <div class="row justify-content-center">
                ...
                <!-- Button a actualiza ) -->
                <div class="col col-md-4">
                <a class="btn btn-success w-100 mt-4" href="actualizaproducto.php?id=<?php echo $resul['id']; ?>">Actualizar</a>
                </div>
                <div class="col col-md-4">
                <a class="btn btn-warning w-100 mt-4" href="insertarproducto.php">Añadir producto</a>
                </div>
                <div class="col col-md-4">
                <a class="btn btn-secondary w-100 mt-4" href="busquedaproducto.php">Buscar productos</a>
                </div>
                <div class="col col-md-4">
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <!-- Button a borrar -->
                            <a class="btn btn-danger" href="eliminaproducto.php?id=<?php echo $resul['id'];?>">Eliminar</a>
                          </div>
                        </div>
                      </div>
                    </div>                   
